    ...
    "bootstrap": {
        "fnInit": function( oSettings, nPaging, fnDraw ) {
            ...
            $(nPaging).addClass('pagination').append(
                ...
                '<input type="text" style="width: 30px;padding-top: 5px;padding-bottom: 5px;height: 30px;border-left: 0px;border-radius: 0px 4px 4px 0px;" id="redirect" class="redirect">'+
                '</ul>'
                );
