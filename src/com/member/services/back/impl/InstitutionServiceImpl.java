...
public class InstitutionServiceImpl implements InstitutionService {
	...
	public Institution getInstitutionInfo() {
		List<Institution> dataPermissionCodes = (List<Institution>) institutionDao
				.queryByHql(HqlInstitution.getInstitutionInfo);
	...
	public Information getNnmuserByName(String number) {
		...
		List arguments = new ArrayList();
		arguments.add(number);
		List<Information> result = (List<Information>) institutionDao
				.queryByHql(hql, arguments);
	...
	public List<BankService> getBankServiceInfo() {
		...
		List<BankService> result = (List<BankService>) institutionDao
				.queryByHql(hql);
		if (result != null && result.size() > 0) {
			return result;
		}
	...
	public List<BankRechargeHistory> getBankRechargeHistoryList() {
		...
		List<BankRechargeHistory> result = (List<BankRechargeHistory>) institutionDao
				.queryByHql(hql);
		return result;
	}
	...
	public Information getInformationById(Integer id) {
		...
		List<Information> listresult = (List<Information>) institutionDao
				.queryByHql(hql, id);
